...
const CheckoutCard = ({inCart}) => {
    ...
    return (
        <div className='border border-neutral-300 py-2'>
            {
                !inCart &&
            ...
            {
                !inCart && <div className='w-full h-[1px] bg-neutral-300 mb-2'></div>
            }
            ...
            <div className='flex items-center justify-between px-2 mb-2 space-x-3 pt-1'>
                <p><BsFillTagsFill /></p>
            ...
            {
                inCart && <div className='w-full h-[1px] bg-neutral-300 my-2'></div>
            }


            {
                inCart &&
                <div className=' mt-2 flex items-center justify-center px-5'>
                    <Link to="/checkout" className='w-full flex items-center justify-center bg-enfanato text-white h-10 hover:outline-dashed outline-1 outline-black'>Proceed to checkout</Link>
                </div>
            }
        </div>
    );
