...
const Topbar = () => {
    ...
    return (
        <div className='h-12 md:h-14  relative w-full'>
            <svg width="100%" height="100%" viewBox="0 0 1000 1000" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" overflow="auto" shapeRendering="auto" fill="#FAB6B6" className='transform rotate-180 absolute top-0 md:h-16 h-12 -z-10 '>
                <defs>
